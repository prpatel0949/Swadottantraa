<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <!-- </li> -->
            <li class="{{ (request()->is('user/program*')) ? 'active' : '' }}"><a href="#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Analytics">My Programs</span></a>
            </li>
            ...
            <li><a href="#"><i class="feather icon-circle"></i><span class="menu-title">Support</span></a>
            </li>

    ...
    <div class="container">
        <section class="section">
            ...
            <div class="section-content">
                ...
                <div class="page-subtitle">Why we created SwaDocs (EMR)?</div>
                <p>With an experience of 20 years, we understand every in and out of the angles related to SwaDocs (EMR). Whether it is patient’s angle or doctor’s angle, after trying and testing, upgrading and updating in multiple variations, we have specifically designed this SwaDocs (EMR) for Psychology.</p>
                ...
                <div class="page-subtitle">Why you should go for our SwaDocs (EMR)?</div>
                <ol>

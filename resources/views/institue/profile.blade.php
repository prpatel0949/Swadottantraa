    	...
    	<div class="content-body">
    		<div class="card">
                <div class="card-content">
                    <form method="POST" action="{{ route('institue.profile.update') }}" id="addForm" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <div class="controls">
                                            <label for="account-username">Institue Code</label>
                                            <div class="d-flex">
                                                <input readonly type="text" value="{{ $user->code }}" class="form-control" id="account-username" placeholder="My Code" disabled data-validation-required-message="This username field is required">
                                            </div>
                                        </div>
                                    </div>
                                </div>

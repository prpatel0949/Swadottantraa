        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="{{ (request()->is('admin/program*') || request()->is('admin/scale*') || request()->is('admin/workout*') || request()->is('admin/user/answer*') ? 'active' : '') }} nav-item"><a href="#"><i class="feather icon-circle"></i><span class="menu-title" data-i18n="User">Program Management</span></a>
                <ul class="menu-content">
                    ...
                    <li class="{{ (request()->is('admin/workout*') ? 'active' : '') }}"><a href="{{ route('workout.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Edit">Workouts</span></a>
                    </li>
                    <li class="{{ (request()->is('admin/user/answer*') ? 'active' : '') }}"><a href="{{ route('admin.user.answer') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Edit">Program Answers</span></a>
                    </li>
                </ul>
            </li>

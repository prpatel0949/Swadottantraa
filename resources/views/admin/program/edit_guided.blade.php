...
<div class="stage-section d-none">
    <div class="card">
        ...
        <div class="card-body">
                        ...
                        <div class="card card-body bg-step">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Step Title</label>
                                        <input type="text" name="step_name[`SrNo`][1]" class="form-control" placeholder="Step Name">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Step Description</label>
                                        <input type="text" name="step_description[`SrNo`][1]" class="form-control" placeholder="Step Description">
                                        <input type="hidden" name="step_index[`SrNo`][1]" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button class="btn btn-outline-primary add-scale-btn" data-index="`SrNo`" data-step="1">Add Scale</button>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button class="btn btn-outline-primary add-workout-btn" data-index="`SrNo`" data-step="1">Add Workout</button>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button class="btn btn-outline-primary add-attachment-btn" data-index="`SrNo`" data-step="1">Add Attachment</button>
                                    </div>
                                </div>
                            </div>
                            <div class="scale-workout-section">
            ...
            <div class="row">
                <div class="col-md-12">
                    <input type="checkbox" name="is_multiple[`SrNo`]" value="1" >
                    <label for="is_multiple">Multiple Answer</label>
                </div>
            </div>

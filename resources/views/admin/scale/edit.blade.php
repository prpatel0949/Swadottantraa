                            ...
                            <div class="card-body p-0">
                                <div class="accordion search-content-info" id="accordionExample">
                                    <div class="collapse-margin search-content mt-0 bg-white">
                                        <div class="card-header" id="headingOne" role="button" data-toggle="collapse" data-target="#intp" aria-expanded="false" aria-controls="collapseOne">
                                            <span class="lead collapse-title">
                                                Interpreatation
                                            </span>
                                        </div>
                                        <div id="intp" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="fom-group float-right">
                                                            <button type="button" class="btn btn-primary add-interpreatation">Add Range</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="interpreatation-section">
                                                    @if (old('start'))
                                                        @foreach (old('start') as $index => $start)
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label>Start</label>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label>End</label>
                                                                        <input type="text" name="end[]" class="form-control" value="{{ old('end.'.$index) }}">
                                                                        @error('end.'.$index)
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Value</label>
                                                                        <input type="text" name="value[]" class="form-control" value="{{ old('value.'.$index) }}">
                                                                        @error('value.'.$index)
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                        ...
                                                        @endforeach
                                                    @else
                                                        @foreach ($scale->interpreatations as $item)
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label>Start</label>
                                                                        <input type="hidden" name="inter_ids[]" value="{{ $item->id }}">
                                                                        <input type="text" name="start[]" class="form-control" value="{{ $item->start }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label>End</label>
                                                                        <input type="text" name="end[]" class="form-control" value="{{ $item->end }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">

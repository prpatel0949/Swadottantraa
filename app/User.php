...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'country_code', 'prefix', 'franchisee_code', 'dob', 'mobile', 'type', 'education', 'profile', 'occupation', 'gender', 'address', 'code', 'tags', 'number_of_users', 'last_checked_at', 'city_id', 'state_id'
    ];
